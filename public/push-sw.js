...
self.addEventListener('push',event=>{
  ...
  const options={body:data.body||'A new non-draft order was created.',icon:data.icon||'/arco-icon.png',badge:data.badge||'/arco-icon.png',tag:data.tag||'arco-new-order',renotify:true,silent:false,requireInteraction:true,data:{url:data.url||APP_URL}};
