...
self.addEventListener('push',event=>{
  ...
  const options={body:data.body||'A new non-draft order was created.',icon:data.icon||'https://pub-afe21e63db9948a78cf5b43bfa17bcb8.r2.dev/app-icon.png',badge:data.badge||'/favicon.svg',tag:data.tag||'arco-new-order',renotify:true,silent:false,requireInteraction:true,data:{url:data.url||APP_URL}};
